...
const PRODUCTS_DATA = [
  {
    "id": "znhi-36a2gmws-lizard",
    "modelId": "ZNHI-36A2GMWS[蜥]",
    "name": "近程自行高炮",
    "nameEn": "Short-range Self-propelled Anti-Aircraft Gun",
    "nickname": "气温35mm",
    "classification": {
      "brand": "ZNHI",
      "series": "蜥",
    ...
    "media": {
      "thumbnail": "products/znhi-36a2gmws-lizard/ZNHI-36A2GMWS.webp",
      "hero": "products/znhi-36a2gmws-lizard/ZNHI-36A2GMWS.webp",
      "gallery": [],
      "originalFiles": [
        "ZNHI-36A2GMWS[蜥].jpg"
      ]
    ...
    "description": {
      "tagline": "雪原上的气温，用口径丈量",
      "summary": "经讨论，-09的低驾驶室导致接近角不佳，监狱决定使用通过性更强的-36A2作为后续通用防空模块搭载平台。火力配置与火控系统保持不变，但更高的底盘与更强的越野能力让她能伴随装甲部队深入复杂地形，在任何需要防空掩护的地方架起那门35mm。",
      "full": "经讨论，-09的低驾驶室导致接近角不佳，监狱决定使用通过性更强的-36A2作为后续通用防空模块搭载平台，火力配置与火控系统保持不变。\n\n-09[象]虽然可靠，但低矮的驾驶室在恶劣地形下饱受诟病——糟糕的接近角让她翻越障碍时总是磕到鼻子。相比之下，-36A2[蜥]拥有更高的底盘、更大的轮胎和更强的越野能力，作为防空模块搭载平台再合适不过。\n\n武器系统完整继承自-09A5GMWS，35mm双管速射炮配合搜索雷达，射速依旧凶猛，火控系统一如既往地精准。不同的是，现在她能跟上装甲纵队翻山越岭，而不是被困在平坦公路上望尘兴叹。"
    },
    "specs": [
      {
        "label": "类型",
    ...
    "designer": {
      "quote": "换了双长腿之后，她终于不用在烂泥里磕鼻子了——同样的火力，更远的路。",
      "author": "典狱长 ZANE",
      "title": "首席设计师"
    },
    "featured": {
      ...
      "background": {
        "imageUrl": "products/znhi-36a2gmws-lizard/ZNHI-36A2GMWS.webp",
        "filters": {
          "opacity": 0.7,
          "saturate": 0.85,
          "contrast": 1.15,
      ...
      "descriptionBlock": {
        "enabled": true,
        "text": "-09的鼻子磕够了，换双长腿继续守护领空。35mm双管速射炮与搜索雷达原封不动，只是现在她能跟上装甲纵队了。",
        "maxWidth": "max-w-lg"
      },
      "specsBlock": {
        "enabled": true,
    ...
    "detail": {
      "breadcrumb": [
        ...
        {
          "text": "ZNHI-36A2GMWS[蜥]"
        }
      ],
      "gallery": {
        "mainImage": {
          "url": "products/znhi-36a2gmws-lizard/ZNHI-36A2GMWS.webp",
          "aspectRatio": "16/9"
        },
        "statusBadges": [
          {
      ...
      "productInfo": {
        ...
        "description": {
          "enabled": true,
          "text": "-09的低驾驶室导致接近角不佳，监狱决定使用通过性更强的-36A2作为后续通用防空模块搭载平台。武器系统与火控完整继承自A5GMWS，35mm双管速射炮配合搜索雷达，在更优越的底盘上继续守护领空。"
        },
        "specs": {
          "enabled": true,
          "title": "规格参数",
        ...
        "designerQuote": {
          "enabled": true,
          "text": "换了双长腿之后，她终于不用在烂泥里磕鼻子了——同样的火力，更远的路。",
          "author": "典狱长 ZANE",
          "title": "首席设计师"
        },
        "ctaButton": {
      ...
      "storyChapters": [
        {
          ...
          "centerContent": {
            ...
            "title": "换脚",
            "content": "-09的鼻子在泥地里磕了太多次。<br/>低矮的驾驶室，糟糕的接近角，每一次翻越障碍都像是在和地面较劲。<br/>监狱决定换一双更长的腿——<br/>于是，-36A2成为了新的防空模块搭载平台。",
            "statusText": {
              "enabled": true,
              "text": "Platform Migration: Complete"
            }
          }
        },
        {
          ...
          "leftContent": {
            ...
            "title": "火力不减",
            "content": "35mm双管速射炮，搜索雷达，火控系统——<br/>一切都原封不动地从-09A5搬了过来。<br/><span class=\"text-white border-b border-primary/40 pb-1\">变的是底盘，不变的是每一发炮弹的精准与凶狠。</span>",
            "dataBlocks": [
              {
                "value": "35mm",
                "label": "口径"
        ...
        },
        {
          ...
          "rightContent": {
            "statusIndicator": {
              "enabled": true,
              "text": "Air Shield Online",
              "isAnimated": true
            },
            "title": "高处的守望",
            "content": "更高的底盘，更强的通过性，更远的路。<br/>她不再被困在平坦的公路上望尘兴叹，<br/>而是跟随装甲纵队翻山越岭，在每一处需要防空掩护的阵地架起那门35mm。<br/>雪原上的气温，从此用口径丈量。",
            "quoteCard": {
              "enabled": true,
              "text": "换了双长腿之后，她终于不用在烂泥里磕鼻子了——同样的火力，更远的路。",
              "author": "典狱长 ZANE",
      ...
      "techSummary": {
        ...
        "description": "ZNHI-36A2GMWS[蜥] 是监狱重工基于-36A2底盘打造的近程自行高炮，完整继承A5GMWS的武器系统与火控，在更优越的底盘上为装甲部队提供伴随防空掩护。",
        "ctaButton": {
          "enabled": true,
          "text": "获取技术手册",
          "subtitle": "含完整维护指南"
        ...
        "products": [
          {
            ...
            "productCode": "ZNHI-09A5GMWS[象]",
            "productName": "轮式综合防空系统",
            "productDesc": "前代防空平台（-09底盘）",
    ...
    "meta": {
      ...
      "version": 1,
      "source": "正式资料.txt",
      "notes": "基于-36A2底盘的防空模块搭载平台，继承A5GMWS武器系统"
    }
  },
  {
    "id": "znhi-41a-weasel",
  ...
  },
  {
    ...
    "name": "STS超限双源机车",
    "nameEn": "STS Oversized Dual-mode Locomotive",
    "nickname": "降弓用刑",
    "classification": {
      "brand": "ZNTP",
      "series": null,
    ...
    "description": {
      "tagline": "电网尽头，柴油接力",
      "summary": "为电气化不完全地区设计的双源机车，支持两种接触网供电制式及柴油供电，兼容客货运但更适合货运领域。154吨的整备重量与臃肿的车身使她超出了STS限界规范，25吨的轴重更让她在欧洲大陆寸步难行。",
      "full": "设计用于在电气化不完全的地区进行运输作业，支持两种接触网供电制式，以及柴油供电，燃油模式功率较低，所有模式极速均为160km/h。兼容客货运，但时速与稳定性都不占优势的她更适合货运领域。\n\n因为技术问题她并没能做到像EuroDual那般紧凑，既要又要的臃肿电气设备导致她整备重量能达到154吨，硕大的车身轮廓直接超出了STS限界标准，25吨的轴重更使她在欧洲大陆寸步难行。"
    },
    "specs": [
      {
        "label": "类型",
    ...
    "featured": {
      ...
      "descriptionBlock": {
        "enabled": true,
        "text": "为电气化不完全地区设计的双源机车，支持双制式接触网及柴油供电。臃肿的电气设备让她直接超出了STS限界标准——在规范面前，她选择了功能优先。",
        "maxWidth": "max-w-lg"
      },
      "specsBlock": {
        "enabled": true,
    ...
    "detail": {
      ...
      "productInfo": {
        ...
        "description": {
          "enabled": true,
          "text": "为电气化不完全地区设计的双源机车，支持两种接触网供电制式及柴油供电。臃肿的双动力系统让她的车身轮廓超出了STS限界标准，25吨的轴重更限制了她的运用范围，但在货运领域她依然是可靠的选择。"
        },
        "specs": {
          "enabled": true,
          "title": "规格参数",
      ...
      "storyChapters": [
        ...
        },
        {
          ...
          "leftContent": {
            ...
            "title": "灵活切换",
            "content": "支持两种接触网供电制式，也能使用柴油动力。<br/>电气化区段高效节能，非电气化区段自主运行。<br/><span class=\"text-white border-b border-primary/40 pb-1\">154 吨的整备重量，超出 STS 限界的车身轮廓——为双动力系统付出的代价。</span>",
            "dataBlocks": [
              {
                "value": "双源",
                "label": "动力"
      ...
      "techSummary": {
        ...
        "description": "ZNTP-19 1023 是为电气化不完全地区设计的STS超限双源机车，支持两种接触网供电制式及柴油供电。臃肿的电气设备让她超出了STS限界标准，但兼容客货运的灵活性使她在货运领域找到了归宿。",
        "ctaButton": {
          "enabled": true,
          "text": "获取技术手册",
          "subtitle": "含完整运维指南"
    ...
    "meta": {
      ...
      "version": 3,
      "source": "正式资料.txt",
      "notes": "v3: 修正STS含义。STS为Scrap Train Standards（废品机械师社区轨道标准），超限指车辆超出STS限界规范，而非物理超重。更新所有相关文案。"
    }
  },
  {
    "id": "zntp-22-127",
  ...
  {
    "id": "zntp-17-9975",
    "modelId": "ZNTP-17 9975",
    "name": "STS界限城际列车",
    "nameEn": "STS-compliant Intercity Train",
    "nickname": null,
    "classification": {
      "brand": "ZNTP",
      "series": null,
    ...
    "media": {
      "thumbnail": "products/zntp-17-9975/ZNTP-17-9975.webp",
      "hero": "products/zntp-17-9975/ZNTP-17-9975.webp",
      "gallery": [
        {
          "src": "products/zntp-17-9975/ZNTP-17-9975-2.webp",
          "alt": "编组侧视图",
          "type": "image"
        }
      ],
      "originalFiles": [
        "Pbr_2k_delpmaspu (1).png",
        "Pbr_2k_delpmaspu.png"
      ]
    },
    "description": {
      "tagline": "每一段旅途，都不该有人被落下",
      "summary": "STS界限时速250公里级城际列车，5节编组，铰接式转向架，小半径弯道特化。特设无障碍车厢（2车），地板与站台平齐，配备轮椅固定器、无障碍厕所、急救AED，让出行不再是特权。",
      "full": "STS界限时速250公里级城际列车，5节编组，铰接式转向架，小半径弯道特化。\n\n她的白灰色车身上点缀着清新的绿色饰带，流线型的头部在弯道中划出利落的弧线。铰接式转向架赋予她在小半径弯道中依然保持高速通过的能力，城际线路上那些令传统列车减速的弯道对她而言不过是一段优雅的舞步。\n\n2车为专设无障碍车厢，地板与STS站台高度平齐，双开门搭配宽体站台补偿器，轮椅用户无需任何辅助即可自主上下车。车厢内配备轮椅固定器、无障碍厕所、急救AED、立式自行车位与折叠座椅。监狱相信，一套交通系统的文明程度，取决于它对待行动不便者的态度。"
    },
    "specs": [
      {
        "label": "类型",
      ...
      {
        "label": "弯道特性",
        "labelEn": "Curve Performance",
        "value": "小半径弯道特化",
        "highlight": false
      },
      {
        "label": "无障碍车厢",
        "labelEn": "Accessible Car",
        "value": "2车（全无障碍设施）",
        "highlight": true
      },
      {
        "label": "UIC编号",
        "labelEn": "UIC Number",
        "value": "51 33 9975 411-1",
        "highlight": false
      }
    ],
    "designer": {
      "quote": "如果一列车只能服务健全的人，那她就只完成了一半的使命。",
      "author": "典狱长 ZANE",
      "title": "首席设计师"
    },
    "featured": {
      ...
      "background": {
        "imageUrl": "products/zntp-17-9975/ZNTP-17-9975.webp",
        "filters": {
          "opacity": 0.7,
          "saturate": 0.95,
          "contrast": 1.1,
      ...
      "descriptionBlock": {
        "enabled": true,
        "text": "250 km/h 城际动车组，铰接式转向架小半径弯道特化。特设无障碍车厢，地板与站台平齐——每一段旅途，都不该有人被落下。",
        "maxWidth": "max-w-lg"
      },
      "specsBlock": {
        "enabled": false,
    ...
    "detail": {
      ...
      "gallery": {
        "mainImage": {
          "url": "products/zntp-17-9975/ZNTP-17-9975.webp",
          "aspectRatio": "16/9"
        },
        "statusBadges": [
          {
        ...
        "thumbnails": [
          ...
          {
            "url": "products/zntp-17-9975/ZNTP-17-9975-2.webp",
            "isActive": false
          }
        ],
        "videoButton": {
      ...
      "productInfo": {
        ...
        "description": {
          "enabled": true,
          "text": "STS界限时速250公里级城际列车，5节编组，铰接式转向架，小半径弯道特化。特设无障碍车厢（2车），地板与站台平齐，配备完整无障碍设施，让每一位旅客都能从容出发。"
        },
        "specs": {
          "enabled": true,
          "title": "规格参数",
        ...
        "designerQuote": {
          "enabled": true,
          "text": "如果一列车只能服务健全的人，那她就只完成了一半的使命。",
          "author": "典狱长 ZANE",
          "title": "首席设计师"
        },
        "ctaButton": {
      ...
      "storyChapters": [
        {
          ...
          "centerContent": {
            ...
            "title": "零落差",
            "content": "2车的地板与站台之间没有台阶，没有缝隙，没有犹豫。<br/>轮椅用户不必等待任何人的帮助，双开门与宽体站台补偿器已经为她铺好了路。<br/>文明的尺度，有时候就藏在这几厘米的落差里。",
            "statusText": {
              "enabled": true,
              "text": "Barrier-free Access: Enabled"
            }
          }
        },
        {
          ...
          "style": "left-technical",
          "background": {
            "imageUrl": "products/zntp-17-9975/ZNTP-17-9975-2.webp",
            "filters": {
              "scale": 1,
              "brightness": 0.95
            }
          ...
          "leftContent": {
            ...
            "iconLabel": "Accessible Design",
            "title": "无声的尊重",
            "content": "轮椅固定器、无障碍厕所、急救AED、立式自行车位、折叠座椅——<br/>这些不是附加选项，而是出厂标配。<br/><span class=\"text-white border-b border-primary/40 pb-1\">监狱相信，一个人的行动能力不应该决定他能走多远。</span>",
            "dataBlocks": [
              {
                "value": "250",
                "label": "时速 km/h"
        ...
        },
        {
          ...
          "centerContent": {
            ...
            "title": "弯道",
            "content": "铰接式转向架在小半径弯道中划出利落的弧线。<br/>250 km/h，弯道不减速，旅途不绕路，出行不设限。",
            "statusText": {
              "enabled": true,
              "text": "250 km/h Curve Certified"
            }
          }
        }
      ],
      "techSummary": {
        ...
        "description": "ZNTP-17 9975 是STS界限时速250公里级城际动车组，采用铰接式转向架，小半径弯道特化。特设无障碍车厢（2车），配备轮椅固定器、无障碍厕所、急救AED等完整无障碍设施，确保每一位旅客都能平等出行。",
        "ctaButton": {
          "enabled": true,
          "text": "获取技术手册",
          "subtitle": "含无障碍服务指南"
  ...
  },
  {
    ...
    "media": {
      "thumbnail": "products/znhi-04aev-ice/ZNHI-04AEV.webp",
      "hero": "products/znhi-04aev-ice/ZNHI-04AEV.webp",
      "gallery": [],
      "originalFiles": [
        "ZNHI-04AEV[冰].png"
      ]
    ...
    "description": {
      "tagline": "典狱长做饭时想要个能帮忙颠锅的孩子",
      "summary": "基于老式-04底盘改装的装甲工程车，配备三段式机械臂，可安装铲斗或钩爪执行挖掘或吊装作业。车体前部配备推土铲，背部设储物架。换装A3A1动力包，比ARV更强劲，但要注意散热。",
      "full": "ZNHI-04AEV[冰]是监狱重工基于老式-04底盘改装的装甲工程车。\n\n典狱长做饭时，突然想要个能帮忙颠锅的孩子，于是便有了她。她配备一台三段式机械臂，可安装铲斗或钩爪进行挖掘或吊装作业，车体前部配备推土铲，背部设储物架。\n\n她基于老式-04底盘改装而来，换装A3A1的动力包，相比ARV有更强的动力。但由于储物架的遮挡，在高温环境下可能导致发动机过热——在雪原倒不是什么问题，反正雪原不缺冷风。"
    },
    "specs": [
      {
        "label": "类型",
    ...
    "featured": {
      ...
      "background": {
        "imageUrl": "products/znhi-04aev-ice/ZNHI-04AEV.webp",
        "filters": {
          "opacity": 0.65,
          "saturate": 0.7,
          "contrast": 1.15,
      ...
      "descriptionBlock": {
        "enabled": true,
        "text": "基于老式-04底盘，配备三段式机械臂与推土铲，典狱长的颠锅帮手。",
        "maxWidth": "max-w-lg"
      },
      "specsBlock": {
        "enabled": false,
    ...
    "detail": {
      ...
      "gallery": {
        "mainImage": {
          "url": "products/znhi-04aev-ice/ZNHI-04AEV.webp",
          "aspectRatio": "16/9"
        },
        "statusBadges": [
          {
      ...
      "productInfo": {
        ...
        "description": {
          "enabled": true,
          "text": "基于老式-04底盘改装，换装A3A1动力包，配备三段式机械臂、推土铲与储物架，比ARV更强劲的工程孩子。"
        },
        "specs": {
          "enabled": true,
          "title": "规格参数",
      ...
      "storyChapters": [
        {
          ...
          "rightContent": {
            ...
            "title": "颠锅的孩子",
            "content": "典狱长做饭时，突然想要个能帮忙颠锅的孩子。<br/>于是便有了她。<br/><br/>基于老式-04底盘改装而来，换装A3A1动力包后，她比ARV拥有更强的动力。<br/>三段式机械臂是她最显眼的特征——可以安装铲斗挖掘，也可以换上钩爪吊装。",
            "quoteCard": {
              "enabled": true,
              "text": "想要个能帮忙颠锅的孩子，于是便有了她。",
              "author": "典狱长 ZANE",
        ...
        },
        {
          ...
          "leftContent": {
            ...
            "iconLabel": "Multi-Function Arm",
            "title": "前铲后架",
            "content": "车体前部配备推土铲，清障开路一抬手的事。<br/>三段式机械臂居中安装，铲斗和钩爪可根据任务快速更换。<br/>背部储物架能携带工具和备件——但它也有副作用。<br/><span class=\"text-white border-b border-primary/40 pb-1\">储物架遮挡了散热，高温环境下发动机可能过热。在雪原倒不是什么问题。</span>",
            "dataBlocks": [
              {
                "value": "3段式",
                "label": "机械臂"
        ...
        },
        {
          ...
          "centerContent": {
            ...
            "title": "比ARV更强劲",
            "content": "A3A1动力包赋予她超越ARV的动力输出。<br/>推土铲清障，机械臂挖掘与吊装，储物架携带工具。<br/>尽管储物架的遮挡让她在烤箱里会受苦，但在雪原上，冷风就是她最好的散热器。",
            "statusText": {
              "enabled": true,
              "text": "A3A1 Powerpack / -04 Legacy Chassis"
            }
          }
        }
      ],
      "techSummary": {
        ...
        "description": "ZNHI-04AEV[冰] 是基于老式-04底盘改装的装甲工程车，换装A3A1动力包，配备三段式机械臂、推土铲与储物架。",
        "ctaButton": {
          "enabled": true,
          "text": "获取产品手册",
          "subtitle": "含工程作业指南"
